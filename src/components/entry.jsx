...
const entry = ({ task }) => {
  return (
    // right-12
    <div className="flex lg:flex-row flex-col gap-2 lg:gap-0 py-1 px-6  bg-white w-full border-b-2 border-gray-300">
      ...
      <div className="flex  justify-between  items-center ">
        <button className="text-xl text-blue-500 p-3 h-12 w-16 flex items-center justify-center  hover:bg-blue-500 hover:text-white transition border-l border-gray-200">
          <FaTag />
        </button>
